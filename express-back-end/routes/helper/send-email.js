            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
              ...
              <tr>
                <td class="wrapper">
                  ...
                  <p>${senderFullName} is inviting you to cook ${api_recipe_name} in a fun cooking session at Kitchen-up!</p>
                      ...
                      <tr>
                        <td align="left">
                          <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                              <tr>
                                <td> <a href="http://localhost:5173/cooking-sessions" target="_blank">See the invitation</a> </td>
                              </tr>
                            </tbody>
                          </table>
                        </td>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">Kitchen Up, 911 Teamup St, Vancouver R2M 2G6</span>
                    <br> Don't like these emails? <a href="mailto:info@kitchenup.com">Unsubscribe</a>.
                  </td>
                </tr>
              </table>
            </div>
